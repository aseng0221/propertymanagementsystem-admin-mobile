...
type FacilityScheduleScreenNavigationProp = NativeStackNavigationProp<FacilitiesStackParamList, 'FacilitySchedule'>;

interface Props {
  navigation: FacilityScheduleScreenNavigationProp;
}
...
const FacilityScheduleScreen: React.FC<Props> = ({ navigation }) => {
...
export default FacilityScheduleScreen;
