...
type ChatScreenNavigationProp = NativeStackNavigationProp<CommunicationStackParamList, 'Chat'>;
type ChatScreenRouteProp = RouteProp<CommunicationStackParamList, 'Chat'>;
